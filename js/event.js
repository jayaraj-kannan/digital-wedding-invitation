...
var addeventatc = function () {
    ...
    return {
        ...
        generate: function () {
            for (var d = document.getElementsByTagName("*"), c = 0; c < d.length; c += 1)
                addeventatc.hasclass(d[c], "addeventatc") && function () {
                    ...
                    l ? (d[c].onclick = function () {
                        ...
                        !1
                    }, d[c].onmouseover = function () {}, d[c].onmouseout = function () {}),
                    ...
                    r && ((o = document.createElement("span")).className = "addeventatc_icon", e.appendChild(o)),
                    s++,
                    v = !0;
            ...
            ();
            r ? addeventatc.applycss() : (addeventatc.removeelement($d("ate_css")), addeventatc.removeelement($d("ate_tmp_css")), addeventatc.helpercss()),
            v && !m && (m = !0, addeventatc.track({
                    typ: "exposure",
                    cal: ""
                }))
        },
        toogle: function (e, t) {
            ...
            if (c) {
                ...
                if ("outlook" == s || "google" == s || "yahoo" == s || "hotmail" == s || "outlookcom" == s || "appleical" == s || "apple" == s || "facebook" == s)
                    ...
                    for (var s, l = (f = (f += ",").replace(/ /gi, "")).split(","), r = 0; r < l.length; r += 1)
                        (h && "ical" == l[r] || h && "appleical" == l[r]) && (n += '<span class="ateappleical" id="' + d + '-appleical" role="menuitem" tabindex="-1">' + N + "</span>"), x && "google" == l[r] && (n += '<span class="ategoogle" id="' + d + '-google" role="menuitem" tabindex="-1">' + A + "</span>");
                    addeventatc.getlicense(p) || (n += ''),
                    $d(d + "-drop") || ((s = document.createElement("span")).id = d + "-drop", s.className = "addeventatc_dropdown", s.setAttribute("aria-hidden", "true"), s.setAttribute("aria-labelledby", d), s.innerHTML = n, c.appendChild(s)),
            ...
            for (var t = "", a = document.getElementsByTagName("*"), n = 0; n < a.length; n += 1)
                if (addeventatc.hasclass(a[n], "addeventatc")) {
                    ...
                    if (o) {
                        ...
                        "block" !== addeventatc.getstyle(o, "display") && (a[n].setAttribute("aria-expanded", "false"), o.setAttribute("aria-hidden", "true"), o.className = o.className.replace(/addeventatc-selected/gi, ""), o.className = o.className.replace(/topdown/gi, ""), o.removeAttribute("style"));
        ...
        viewport: function () {
            ...
            a = document.all ? (n = document.documentElement.scrollLeft || document.body.scrollLeft, document.documentElement.scrollTop || document.body.scrollTop) : (n = window.pageXOffset, window.pageYOffset), {
                w: e,
                h: t,
                x: n,
                y: a
        ...
        getlicense: function (e) {
            ...
            e && (t = e.substring(0, 1), a = e.substring(9, 10), n = e.substring(17, 18), "a" == t && "z" == a && "m" == n && (d = !0)),
        ...
        getguid: function () {
            ...
            return "" == n && (e = (addeventatc.s4() + addeventatc.s4() + "-" + addeventatc.s4() + "-4" + addeventatc.s4().substr(0, 3) + "-" + addeventatc.s4() + "-" + addeventatc.s4() + addeventatc.s4() + addeventatc.s4()).toLowerCase(), (t = new Date).setTime(t.getTime() + 31536e6), t = "expires=" + t.toUTCString(), document.cookie = "addevent_track_cookie=" + e + "; " + t, n = e),
            n
        },
        s4: function () {
        ...
        settings: function (e) {
            ...
            null != e.css && (e.css ? r = !0 : (r = !1, addeventatc.removeelement($d("ate_css")))),
            ...
            null != e.appleical && null != e.appleical.show && (h = e.appleical.show),
            null != e.facebook && null != e.facebook.show && (T = e.facebook.show),
            null != e.outlook && null != e.outlook.text && (z = e.outlook.text),
            null != e.google && null != e.google.text && (A = e.google.text),
            null != e.office365 && null != e.office365.text && (E = e.office365.text),
            ...
            null != e.dropdown && null != e.dropdown.order && (f = e.dropdown.order)
        },
        keyboard: function (e, t) {
            ...
            if (a && "block" == addeventatc.getstyle(a, "display")) {
                ...
                for (var s, i = d = 0; i < n.length; i += 1)
                    ++d == c ? (n[i].className += " drop_markup", n[i].tabIndex = "0", n[i].focus()) : (s = new RegExp("(\\s|^)drop_markup(\\s|$)"), n[i].className = n[i].className.replace(s, " "), n[i].className = n[i].className.replace(/\s+$/, ""), n[i].tabIndex = "-1")
            }
        },
...
var flbckcnt = 0, flbckint = setInterval(function () {
    15 <= ++flbckcnt || addeventatc.isloaded() ? clearInterval(flbckint) : addeventatc.initialize()
}, 300), nlbckcnt = 0, nlbckint = setInterval(function () {
